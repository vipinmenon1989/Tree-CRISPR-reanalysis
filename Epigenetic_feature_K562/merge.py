...
# Execution
file_1 = 'TreeCRISPRi_lib_TSS_revised_bins_complete_epi_K562.txt'
file_2 = 'TreeCRISPRi_lib_TSS_revised_bins_guide_K562.txt'
output_file = 'TreeCRISPRi_lib_merged_K562.txt'
