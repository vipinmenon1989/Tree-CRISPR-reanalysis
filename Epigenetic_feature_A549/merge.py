...
# Execution
file_1 = 'TreeCRISPRi_lib_TSS_revised_bins_complete_epi_A549.txt'
file_2 = 'TreeCRISPRi_lib_TSS_revised_bins_guide_A549.txt'
output_file = 'TreeCRISPRi_lib_merged_A549.txt'
