...
def main():
    ...
    input_matrix_file = os.path.join(working_dir, "ALKE_gene_balanced_data_K562.txt")
    gene_list_file = os.path.join(working_dir, "TreeCRISPRi_ESG_list.txt")
    output_final_file = os.path.join(working_dir, "ALKE_gene_balanced_data_K562_subset.txt")
