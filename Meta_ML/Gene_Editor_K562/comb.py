...
def main():
    ...
    # Path inputs
    epigenetic_file = os.path.join(working_dir, "TreeCRISPRi_lib_TSS_revised_bins_complete_epi_K562.txt") 
    master_editor_file = os.path.join(working_dir, "K562_all_editors_master_matrix.txt")
    output_merged_file = os.path.join(working_dir, "K562_training_ready_matrix.txt")
    ...
    exclude_cols = [
        ...
        'distance_to_TSS', 'closest_TSS_coord'
    ]
