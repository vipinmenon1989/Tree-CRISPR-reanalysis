...
def main():
    ...
    metrics_file = os.path.join(output_dir, "xgb_baseline_metrics.txt")
    feat_importance_file = os.path.join(output_dir, "xgb_baseline_feature_importance.csv")
    model_output_path = os.path.join(output_dir, "best_xgb_baseline_model.pkl")
    ...
    with open(metrics_file, 'w') as f:
        f.write("==================================================\n")
        f.write("XGBOOST ABLATION BASELINE PERFORMANCE METRICS\n")
        f.write("==================================================\n")
