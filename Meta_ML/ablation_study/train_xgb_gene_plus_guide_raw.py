...
def main():
    ...
    metrics_file = os.path.join(output_dir, "xgb_gene_plus_guide_raw_metrics.txt")
    feat_importance_file = os.path.join(output_dir, "xgb_gene_plus_guide_raw_feature_importance.csv")
    model_output_path = os.path.join(output_dir, "best_xgb_gene_plus_guide_raw_model.pkl")
    ...
    with open(metrics_file, 'w') as f:
        f.write("==================================================\n")
        f.write("XGBOOST ABLATION GENE + GUIDE RAW PERFORMANCE METRICS\n")
        f.write("==================================================\n")
