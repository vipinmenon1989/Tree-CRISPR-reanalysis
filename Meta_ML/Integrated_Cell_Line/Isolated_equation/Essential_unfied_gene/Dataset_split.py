...
def execute_all_matrix_splits(matrix_path, output_dir):
    ...
    for all three cross-validation configurations: Randomized, Unseen Guides, and Unseen Genes.
    """
    print("======================================================================")
    print("[*] STEP 4: BATCH STRUCTURAL DATA SPLIT ENGINE (ALL MODES ACTIVE)")
    print("======================================================================\n")
    ...
    # Define the 3 targeted split frameworks to execute sequentially
    split_modalities = ['random', 'unseen_guides', 'unseen_genes']
    ...
    for mode in split_modalities:
        ...
        if mode == 'unseen_genes' and len(overlapping_genes) > 0:
            ...
            sys.exit(1)
        elif mode == 'unseen_guides' and len(overlapping_guides) > 0:
    ...
    print("\n======================================================================")
    print("[-->] ALL THREE SYSTEM FORMATS GENERATED AND WRITTEN CLEANLY TO DISK")
    print("======================================================================\n")

if __name__ == "__main__":
    # Cluster pathing targeted directly to your matrix workspace layout
    target_working_dir = "/local/projects-t3/lilab/vmenon/CRISPRi/Re-analysis/Meta_ML/Integrated_Cell_Line/Isolated_equation/Essential_unfied_gene/"
    input_matrix = os.path.join(target_working_dir, "Unified_target_genes_data.txt")
