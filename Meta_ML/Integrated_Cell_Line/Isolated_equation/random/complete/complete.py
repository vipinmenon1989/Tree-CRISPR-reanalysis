...
def main():
    ...
    # Updated output names to clearly denote the randomized execution run
    ...
    # ==================================================================
    # This matches your exact requested configuration for general training mixing
    ...
    # Grid search parameters adjusted to give the model room to scale over 2,103 rows
    param_grid = {
    ...
    # 7. Save Performance Metrics Log
