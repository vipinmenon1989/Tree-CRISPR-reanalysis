...
def main():
    ...
    # Path configuration for model checkpoint and evaluation outputs (random split baseline)
    model_output_path = os.path.join(working_dir, "random_split_baseline_model_720.json")
    metrics_output_path = os.path.join(working_dir, "random_split_baseline_metrics_720.txt")
    curves_png_path = os.path.join(working_dir, "random_split_baseline_curves_720.png")
    curves_pdf_path = os.path.join(working_dir, "random_split_baseline_curves_720.pdf")
    shap_png_path = os.path.join(working_dir, "random_split_baseline_shap_720.png")
    shap_pdf_path = os.path.join(working_dir, "random_split_baseline_shap_720.pdf")
    ...
    # Constrained parameters to guard against overfitting on small row volume
    param_grid = {
    ...
    with open(metrics_output_path, 'w') as f:
        f.write("=== Baseline Sequence Model Metrics (Random Split - 720 Rows) ===\n")
    ...
    print(f"[-->] Baseline random split script completed inside {working_dir}")
