...
if __name__ == "__main__":
    ...
    target_working_dir = "/local/projects-t3/lilab/vmenon/CRISPRi/Re-analysis/Meta_ML/Integrated_Cell_Line/Isolated_equation/"
    input_matrix = os.path.join(target_working_dir, "Unified_GenomeWide_3CellLine_Matrix.txt")
