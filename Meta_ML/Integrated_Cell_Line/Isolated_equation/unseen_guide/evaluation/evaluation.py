...
def main():
    ...
    working_dir = "/local/projects-t3/lilab/vmenon/CRISPRi/Re-analysis/Meta_ML/Integrated_Cell_Line/Isolated_equation/unseen_guide/evaluation/"
    
    # Point this to your fresh, out-of-sample evaluation data file
    eval_file = os.path.join(working_dir, "CRISPRi_ML_Holdout_Test_20_unseen_guides.txt") 
