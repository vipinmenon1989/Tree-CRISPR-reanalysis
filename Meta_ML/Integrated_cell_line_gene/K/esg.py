...
file_1_path = "merged_K_dataset.csv"  # Your main feature table
...
# Apply dual filtration: Keep rows where mean_sigmoid_score > 0.25 AND class is not 0
print("Filtering features: mean_sigmoid_score > 0.25 AND class != 0...")
df_features = df_features[(df_features["mean_sigmoid_score"] > 0.25) & (df_features["class"] != 0)]
