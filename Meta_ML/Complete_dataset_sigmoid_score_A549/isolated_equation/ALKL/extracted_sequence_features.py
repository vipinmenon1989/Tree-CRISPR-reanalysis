...
def main():
    input_file = "ALKL_A549_training_epigenetics_scaled.txt"
    output_file = "CRISPR_ml_features_final_A549.csv"
    ...
    keep_cols = ['ID', 'sgRNA Sequence', 'Sigmoid_Score', 'Gene', 'distance_to_TSS', 'class','Chromosome','Start','End','Strand','extended_sequence']
