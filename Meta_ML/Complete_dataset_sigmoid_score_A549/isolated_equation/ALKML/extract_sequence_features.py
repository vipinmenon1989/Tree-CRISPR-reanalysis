...
def main():
    working_dir = "./"
    input_file = os.path.join(working_dir, "ALKML_A549_training_epigenetics_scaled.txt")
    output_file = os.path.join(working_dir, "CRISPR_ml_features_final_ALKME_A549.csv")
