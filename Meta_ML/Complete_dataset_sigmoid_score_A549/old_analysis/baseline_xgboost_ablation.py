...
def main():
    ...
    # --- CORRECTED FEATURE SELECTION (STRICT SUBTRACTIVE) ---
    ...
    # 3. Baseline Logic: Drop ALL Epigenetics (Gene and Guide level)
    # Catching A549-specific, H3K, ATAC, methylation, and guide_ columns
    ...
    print(f"CORRECTED Baseline feature space shape: {X.shape}")
