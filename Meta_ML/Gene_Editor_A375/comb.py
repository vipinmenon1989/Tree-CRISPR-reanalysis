...
def main():
    ...
    # Path inputs
    epigenetic_file = os.path.join(working_dir, "TreeCRISPRi_lib_TSS_revised_bins_complete_epi_A375.txt") 
    master_editor_file = os.path.join(working_dir, "A375_final_subset_training_matrix.txt")
    output_merged_file = os.path.join(working_dir, "ALKE_training_ready_matrix_A375.txt")
