...
def main():
    ...
    # Feature Selection: Baseline + Gene Epi
    ...
    # Export
    best.save_model(os.path.join(working_dir, "reg_gene_epi_model.json"))
    with open(os.path.join(working_dir, "reg_gene_epi_metrics.txt"), 'w') as f:
