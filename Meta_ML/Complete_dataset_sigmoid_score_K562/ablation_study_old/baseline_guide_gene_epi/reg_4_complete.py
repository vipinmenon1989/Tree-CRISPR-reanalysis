...
# SCRIPT 4 Feature Logic
X = X_base.copy()
print(f"Feature space size (Complete): {X.shape[1]}")
...
# Save the model
best_model.save_model("reg_4_complete_model.json")
...
with open("reg_4_complete_metrics.txt", "w") as f:
    f.write("=== Complete Epigenetic Regressor Metrics ===\n")
