...
def main():
    ...
    # Path configuration for multi-omic checkpoint and evaluation logs
    model_output_path = os.path.join(working_dir, "unseen_gene_multiomic_model.json")
    metrics_output_path = os.path.join(working_dir, "unseen_gene_multiomic_metrics.txt")
    curves_png_path = os.path.join(working_dir, "unseen_gene_multiomic_curves.png")
    curves_pdf_path = os.path.join(working_dir, "unseen_gene_multiomic_curves.pdf")
    shap_png_path = os.path.join(working_dir, "unseen_gene_multiomic_shap.png")
    shap_pdf_path = os.path.join(working_dir, "unseen_gene_multiomic_shap.pdf")
    ...
    # ==================================================================
    # 2. FEATURE ISOLATION ENGINE: SEQUENCE + ALL EPIGENETIC BINS
    # ==================================================================
    ...
    for col in df_master.columns:
        # Retain all epigenetic chromatin tracks (h3k, atac, methylation, etc.)
    ...
    # ==================================================================
    # 4. XGBOOST OPTIMIZATION ENGINE CONFIGURATION (ASYMMETRIC GRADIENS)
    # ==================================================================
    ...
    # Broad grid calibrated to allow tree splits to balance structural accessibility with sequence code
    param_grid = {
    ...
    # ==================================================================
    # 5. STRATIFY INTERNAL TUNING VIA STRICT GROUPKFOLD (PR-AUC SEARCH)
    # ==================================================================
    ...
    with open(metrics_output_path, 'w') as f:
        f.write("=== Multi-Omic Sequence + Epigenetic Model Metrics (Unseen Gene Split) ===\n")
    ...
    print(f"[-->] Multi-omic script complete. Review metrics output file inside: {working_dir}")
