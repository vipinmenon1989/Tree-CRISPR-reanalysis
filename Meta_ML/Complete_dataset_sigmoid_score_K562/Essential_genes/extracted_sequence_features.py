...
def main():
    input_file = "ALKE_epigenetic_training_clean_K562.txt"
    ...
    # Corrected 'Sigmoid_score' casing to match input file and added 'class'
    keep_cols = ['ID', 'Sigmoid_score', 'class', 'distance_to_TSS']
