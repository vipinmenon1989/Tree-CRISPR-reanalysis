...
def main():
    ...
    metrics_file = "baseline_classification_metrics.txt"
    coef_csv = "baseline_top_sequence_features_class.csv"
    model_output_path = "best_baseline_logistic_elasticnet.pkl"
    ...
    print("Starting baseline Elastic Net Logistic Regression training...")
    ...
    with open(metrics_file, 'w') as f:
        f.write("==================================================\n")
        f.write("BASELINE ELASTIC NET CLASSIFICATION METRICS\n")
        f.write("==================================================\n")
