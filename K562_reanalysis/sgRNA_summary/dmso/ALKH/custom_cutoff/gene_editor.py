...
def main():
    ...
    # ======================================================================
    working_dir = "/local/projects-t3/lilab/vmenon/CRISPRi/Re-analysis/K562_reanalysis/sgRNA_summary/dmso/ALKH/custom_cutoff/"
    
    # Input CSV file name as specified
    input_file = os.path.join(working_dir, "ALKH_hits_complete.csv")
