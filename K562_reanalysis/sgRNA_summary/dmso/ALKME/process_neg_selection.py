...
if __name__ == "__main__":
    # --- CONFIGURATION ---
    FILE_PATH = "output.d14_ALKM_E_dmso_R1,d14_ALKM_E_dmso_R2_vs_d0_ALKM_E_R1,d0_ALKM_E_R2.sgrna_summary.txt" 
    ...
    # --- SAVE ---
    df_full_scored.to_csv("Scored_sgRNA_Matrix_isolated_equation.csv", index=False)
