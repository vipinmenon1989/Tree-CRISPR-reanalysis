...
def process_mageck_negative_selection(sgrna_file, control_label, b_param=2.89, n_param=1.19, ntc_percentile=0.95):
    """
...
if __name__ == "__main__":
    # --- CONFIGURATION ---
    FILE_PATH = "output.d14_ALK_E_dmso_R1,d14_ALK_E_dmso_R2_vs_d0_ALK_E_R1,d0_ALK_E_R2.sgrna_summary.txt" 
